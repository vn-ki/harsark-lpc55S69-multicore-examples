...
PROVIDE(BusFault_0 = BusFaultHandler);
PROVIDE(UsageFault_0 = UsageFaultHandler);
PROVIDE(SecureFault_0 = DefaultHandler);
PROVIDE(SVCall_0 = SVCall_0);
PROVIDE(DebugMonitor_0 = DefaultHandler);
PROVIDE(PendSV_0 = PendSV_0);
...
PROVIDE(BusFault_1 = BusFaultHandler);
PROVIDE(UsageFault_1 = UsageFaultHandler);
PROVIDE(SecureFault_1 = DefaultHandler);
PROVIDE(SVCall_1 = SVCall_1);
PROVIDE(DebugMonitor_1 = DefaultHandler);
PROVIDE(PendSV_1 = PendSV_1);
